...
from MvtecAdDataset import MvtecAdDataset
from utils.utils import data_augmentation, plot_confusion_matrix, get_bbox_from_heatmap
...
class TrainModel(): 
    ...
    def train(self, epochs=5, target_accuracy=None, learning_rate= 0.0001, data_aug=0):
